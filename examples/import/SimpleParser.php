<?php
// $ANTLR 3.1.3 Mar 17, 2009 19:23:44 C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g 2009-04-20 01:01:59
...
class SimpleParser extends AntlrParser {
    ...
    public function file(){
        ...
        try {
            ...
            // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:11:8: ( decl )+ 
            $cnt1=0;
            //loop1:
            do {
                $alt1=2;
    ...
    // $ANTLR start "decl"
    // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:14:1: decl : 'var' ID ( '=' expr )? ';' ; 
    public function decl(){
        $ID2=null;

        try {
            // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:14:6: ( 'var' ID ( '=' expr )? ';' ) 
            // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:14:8: 'var' ID ( '=' expr )? ';' 
            {
            ...
            // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:14:17: ( '=' expr )? 
            $alt2=2;
            ...
            switch ($alt2) {
                case 1 :
                    // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:14:18: '=' expr 
                    {
    ...
    // $ANTLR start "expr"
    // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:18:1: expr : ( INT | FLOAT ); 
    public function expr(){
        try {
            // C:\\data\\home\\ewger\\development\\php\\antlrPhp\\examples\\import\\Simple.g:18:6: ( INT | FLOAT ) 
